...
Jika menggunakan XAMPP, pindahkan atau clone repositori ke `C:/xampp/htdocs/` sehingga pathnya menjadi `C:/xampp/htdocs/RentRoom`.
...
- Buat database baru (misal `rentroom_db`).
